...
class NN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size):
        ...
        in_channels = 65
        out_channels = 64
        self.conv_3 = nn.Conv1d(in_channels, out_channels, kernel_size, stride=stride, padding=padding,
        ...
        in_channels = 64
        out_channels = 2
        self.conv_1 = nn.Conv1d(in_channels, out_channels, kernel_size, stride=stride, padding=padding,
                                dilation=dilation, groups=1, bias=True)
